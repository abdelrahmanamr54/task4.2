...
namespace task4v2
{
    public static class AccountUtil
    {
        ...
        public static void Display(List<CheckingAccoun> accounts)
        {
            Console.WriteLine("\n=== Accounts ==========================================");
            foreach (var acc in accounts)
            {
        ...
        public static void Deposit(List<CheckingAccoun> accounts, double amount)
        {
            Console.WriteLine("\n=== Depositing to Accounts =================================");
            foreach (var acc in accounts)
            {
        ...
        public static void Withdraw(List<CheckingAccoun> accounts, double amount)
        {
            Console.WriteLine("\n=== Withdrawing from Accounts ==============================");
            foreach (var acc in accounts)
            {
